CREATE OR REPLACE FUNCTION public.get_dashboard_metrics(p_start_date date DEFAULT (CURRENT_DATE - '30 days'::interval), p_end_date date DEFAULT CURRENT_DATE)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
BEGIN
    ...
    WHERE o.created_at >= p_start_date
      ...
      AND oi.product_id = 1
      AND o.billing_status IN ('paid', 'partially-refunded')
      AND o.funnel_name LIKE '%31daywisdom.com%';
    ...
    WHERE o.created_at >= p_start_date
      ...
      AND oi.product_id = 1
      AND o.billing_status IN ('paid', 'partially-refunded')
      AND o.funnel_name LIKE '%31daywisdomchallenge.com%';
    ...
    -- ========================================================================
    -- SECTION 3.5: EXTRA JOURNALS (product_id = 4)
    -- ========================================================================
    ...
    -- ========================================================================
    -- SECTION 3.6: EXTRA SHIPPING (product_id = 2)
    -- ========================================================================
    
    SELECT COUNT(DISTINCT o.id)
    INTO v_extra_shipping
    FROM orders o
    JOIN order_items oi ON o.id = oi.order_id
    WHERE o.created_at >= p_start_date
      AND o.created_at < p_end_date + INTERVAL '1 day'
    ...
    -- ORGANIC Extra Shipping
    SELECT COUNT(DISTINCT o.id)
    INTO v_organic_extra_shipping
    FROM orders o
    JOIN order_items oi ON o.id = oi.order_id
    WHERE o.created_at >= p_start_date
      AND o.created_at < p_end_date + INTERVAL '1 day'
    ...
    v_result := jsonb_build_object(
        ...
        'paidAdsFunnel', jsonb_build_object(
            ...
            'extraShipping', v_paid_extra_shipping,
        ...
        'organicFunnel', jsonb_build_object(
            ...
            'extraShipping', v_organic_extra_shipping,
        ...
        'validation', jsonb_build_object(
            ...
            'extraJournalsMatch', v_extra_journals = v_paid_extra_journals + v_organic_extra_journals,
            'extraShippingMatch', v_extra_shipping = v_paid_extra_shipping + v_organic_extra_shipping,
