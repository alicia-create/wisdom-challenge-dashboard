...
export default function DebugGoogleCampaigns() {
  ...
  const { data, isLoading } = trpc.debug.googleCampaigns.useQuery({
    page,
    pageSize: 50,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8">
        <Card>
          <CardHeader>
            <CardTitle>Google Campaigns Debug</CardTitle>
            <CardDescription>
              View and search all Google Ads campaigns in the database
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  // Generate CSV
                  const headers = ['Date', 'Campaign', 'Ad Set', 'Ad', 'Spend', 'Impressions', 'Clicks', 'Leads', 'Purchases'];
                  ...
                  a.href = url;
                  a.download = `google-campaigns-${new Date().toISOString().split('T')[0]}.csv`;
                  a.click();
                    ...
                    {isLoading ? (
                      ...
                      data?.data.map((campaign: any, index: number) => (
                        <TableRow key={`${campaign.id}-${index}`}>
                          ...
                          <TableCell className="text-right">
                            {formatNumber(parseInt(campaign.clicks || '0', 10))}
                          </TableCell>
                          <TableCell className="text-right">
