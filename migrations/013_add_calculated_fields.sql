-- ============================================================================
-- Migration 013: Add ALL calculated fields to get_dashboard_metrics
-- PERFORMANCE OPTIMIZATION: Move all calculations from frontend to SQL
-- ============================================================================
-- This adds: cpc, cpm, ctr, cpp, cpl, salesRate, leadRate, purchases, leads
-- to metaPerformance, metaCampaignBreakdown (all types), and googlePerformance
-- ============================================================================
