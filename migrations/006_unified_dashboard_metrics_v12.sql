-- ============================================================================
-- UNIFIED DASHBOARD METRICS FUNCTION v12
-- ============================================================================
-- Changes from v11:
-- 1. Fixed Paid vs Organic logic:
--    - Paid: ae.comment ILIKE '%31daywisdom.com%' (if passed through paid funnel, attribute to paid)
--    - Organic: ae.comment ILIKE '%31daywisdomchallenge.com%' AND NOT ILIKE '%31daywisdom.com%'
-- 2. Removed UTM-based queries
-- 3. Fixed VSL events: vidalytics.view_video with 5%, 25%, 50%, 95%
-- 4. Added welcome email clicks
-- 5. Meta Performance uses ad_performance table only
-- ============================================================================
...
BEGIN
    ...
    -- ========================================================================
    -- SECTION 9: META PERFORMANCE (all metrics from ad_performance)
    -- ========================================================================
