-- ============================================================================
-- UNIFIED DASHBOARD METRICS SQL FUNCTION v3
-- ============================================================================
-- FIXED: Using ae.name = 'form.submitted' AND ae.comment ILIKE '%wisdom%'
-- ============================================================================
...
BEGIN
    ...
    -- Filter: name='form.submitted' AND comment ILIKE '%wisdom%'
    -- ========================================================================
