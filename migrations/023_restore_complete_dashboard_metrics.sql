-- ============================================================================
-- Migration 023: Restore Complete get_dashboard_metrics Function
-- CRITICAL FIX: Migration 022 accidentally removed most fields
-- This restores ALL fields while keeping the funnel_name fix from Migration 021/022
-- ============================================================================
...
BEGIN
    ...
    -- CTE 4: Product sales breakdown - FIXED: Use funnel_name from orders
    product_sales AS (
        SELECT
    ...
    -- CTE 7: VSL metrics (video watch percentages)
    vsl_metrics AS (
        SELECT
...
-- Add comment
COMMENT ON FUNCTION get_dashboard_metrics IS 'v23 - COMPLETE: All fields restored with funnel_name fix from v21/22';
