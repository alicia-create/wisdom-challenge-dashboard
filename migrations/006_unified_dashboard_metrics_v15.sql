-- ============================================================================
-- UNIFIED DASHBOARD METRICS FUNCTION v15
-- ============================================================================
...
BEGIN
    ...
    v_result := jsonb_build_object(
        ...
        'kpis', jsonb_build_object(
            ...
            ,'cplAds', CASE WHEN v_paid_leads > 0 THEN ROUND(((v_meta_leads_spend + v_meta_sales_spend) / v_paid_leads)::NUMERIC, 2) ELSE 0 END            ,'cppAds', CASE WHEN v_paid_wisdom_sales > 0 THEN ROUND(((v_meta_leads_spend + v_meta_sales_spend) / v_paid_wisdom_sales)::NUMERIC, 2) ELSE 0 END            ,'trueCpl', CASE WHEN v_total_leads > 0 THEN ROUND((v_total_spend / v_total_leads)::NUMERIC, 2) ELSE 0 END            ,'trueCpp', CASE WHEN v_wisdom_sales > 0 THEN ROUND((v_total_spend / v_wisdom_sales)::NUMERIC, 2) ELSE 0 END
        ),
