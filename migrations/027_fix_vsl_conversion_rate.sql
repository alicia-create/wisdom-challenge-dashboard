...
-- Add comment
COMMENT ON FUNCTION get_dashboard_metrics IS 'v27 - Fixed VSL conversion rate to use 50% baseline and count only purchases from VSL viewers. Added drop-off percentages between milestones.';
