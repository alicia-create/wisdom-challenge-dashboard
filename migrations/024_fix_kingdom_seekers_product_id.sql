-- ============================================================================
-- Migration 024: Fix Kingdom Seekers Count Using product_id
-- Kingdom Seekers is tracked by product_id in order_items, not by funnel_name
-- Product ID: 8 (Kingdom Seekers - 60 Days) - excluding product_id 9 (Free Trial)
-- ============================================================================
...
-- Add comment
COMMENT ON FUNCTION get_dashboard_metrics IS 'v24 - FIX: Kingdom Seekers now uses product_id (8, 9) from order_items instead of funnel_name';
