-- ============================================================================
-- Migration 021: Fix Order Filtering - Use funnel_name from orders table
-- CRITICAL FIX: Orders should be filtered by funnel_name field, NOT by analytics_events
-- Paid: funnel_name LIKE '%31daywisdom.com%'
...
BEGIN
    ...
    -- CTE 4: Product sales breakdown - FIXED: Use funnel_name from orders, not analytics_events
    product_sales AS (
        SELECT
...
-- Add comment
COMMENT ON FUNCTION get_dashboard_metrics IS 'v21 - FIXED: Orders filtered by funnel_name field (paid=31daywisdom.com, organic=31daywisdomchallenge.com)';
