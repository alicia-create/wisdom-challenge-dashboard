-- ============================================================================
-- UNIFIED DASHBOARD METRICS SQL FUNCTION v6
-- ============================================================================
-- Changes from v5:
-- 1. CPL, CPP, ROAS calculated only on campaigns with "LEADS" or "SALES"
-- 2. Removed Connect Rate from KPIs
-- 3. Wisdom Conversion = Total Wisdom Sales / Total Leads
-- 4. ManyChat Rate in funnels = manychat_id / leads (not kingdom seekers)
-- 5. VSL dropOff5Percent = (leads - vsl5%) / leads
-- ============================================================================
...
BEGIN
    ...
    v_result := jsonb_build_object(
        ...
        'kpis', jsonb_build_object(
            ...
            -- CPL, CPP, ROAS calculated on LEADS/SALES campaigns only
            'cpl', CASE WHEN v_total_leads > 0 THEN ROUND(v_leads_sales_spend / v_total_leads, 2) ELSE 0 END,
            'cpp', CASE WHEN v_wisdom_sales > 0 THEN ROUND(v_leads_sales_spend / v_wisdom_sales, 2) ELSE 0 END,
